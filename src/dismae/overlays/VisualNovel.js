Dismae.VisualNovel = function (game, scene) {
  this.scene = scene;
  this.game = game;
        ...
        case '{':
          ...
          switch(this.scriptStatement.action){
            case 'show':
              ...
              this.sprites[this.scriptStatement.target].tween.to({x: this.scriptStatement.end.x, y: this.scriptStatement.end.y, alpha: this.scriptStatement.end.alpha}, 1000, Phaser.Easing[this.scriptStatement.easing.function][this.scriptStatement.easing.type]);
